...
data6['date'].dt.year.value_counts()
data6['date'].dt.day_name(locale='ko_kr') # 요일 한국어로
...
q2 = data6[var_list].corr()['price'].drop('price')

q2.abs().idxmax(), q2.abs().idxmin()
...
q3 = lm.pvalues.index[lm.pvalues < 0.05].drop('Intercept')

len(q3) # 13

(lm.params[q3] < 0).sum() # 음수인거 찾기 #
